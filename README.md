# jhipsterSampleApplicationGateway
...
To build the final jar and optimize the jhipsterSampleApplicationGateway application for production, run:
...
Then navigate to [http://localhost:8185](http://localhost:8185) in your browser.
