...
import ke.co.macoz.jhipster.gateway.config.KafkaProperties;
...
class JhipsterSampleApplicationGatewayKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationGatewayKafkaResource kafkaResource = new JhipsterSampleApplicationGatewayKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-gateway-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-gateway-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
