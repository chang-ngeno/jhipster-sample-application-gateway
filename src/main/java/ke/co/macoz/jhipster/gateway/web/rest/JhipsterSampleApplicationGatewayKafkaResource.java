...
@RestController
@RequestMapping("/api/jhipster-sample-application-gateway-kafka")
public class JhipsterSampleApplicationGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplicationGatewayKafkaResource(KafkaProperties kafkaProperties) {
